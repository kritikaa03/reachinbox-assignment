...
const ThreadEmail = () => {
  ...
  useEffect(() => {
    ...
    return () => document.removeEventListener("keydown", handleKeyR);
  }, []);
  ...
  useEffect(() => {
    ...
    return () => document.removeEventListener("keydown", handleKeyD);
  }, []);
    ...
    <>
      <section className="middle border border-[#23272C] w-[850px] relative">
        ...
        {openEditor && (
          ...
          >
            <div
              className={`rounded-lg w-[830px] h-[70%] mt-48 ml-6 border bg-[black]`}
            >
